...
| nlevgrnd     | 15, 30           | __                 | --        | Excluded because the input data is constructed based on the default of 15. Would need different SPEL input files captured from ELM runs with different lake layer settings |
| nlevlak      | 10, 25           | __                 | --        | Excluded because the input data is constructed based on the default of 10. Would need different SPEL input files captured from ELM runs with different lake layer settings |
| nlevsoi      | 1-15, 23           | __                 | --        | Excluded because the input data is constructed based on the default of 10. Would need different SPEL input files captured from ELM runs with different lake layer settings |
| nlevsno      | 5, 16            | __                 | --        | Excluded because the input data is constructed based on the default of 5. Would need different SPEL input files captured from ELM runs with different lake layer settings  |
