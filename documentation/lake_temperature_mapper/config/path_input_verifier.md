...
if the path must be to an existing object on the filesystem, and if that object
...
file is independant of the computer it was created on (it is only dependant on
