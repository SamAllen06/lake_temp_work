...
from root import CONFIG_ROOT, APP_ROOT

CONFIG_FILE = CONFIG_ROOT / "output" / "files.ini"

CONFIG = ConfigParser()
CONFIG.read(CONFIG_FILE)

SAMPLES_DIRECTORY = Path(CONFIG["Directories"]["samples"])
ERRORS_DIRECTORY = Path(CONFIG["Directories"]["errors"])
SAMPLE_ANALYSIS_DIRECTORY = Path(CONFIG["Directories"]["analysis"]) / "sample"
GROUP_ANALYSIS_DIRECTORY = Path(CONFIG["Directories"]["analysis"]) / "group"
